...
using latticefilter_ma = sel::eng::proc::lattice_filter_t <ut_traits, sel::eng::proc::MA_impl<ut_traits> > ;
...
struct sig_gen_ramp : sel::eng::Processor01A<1>
{
	size_t i = 0;
...
sel::eng::Const refection_coefficients = std::vector<double>(
	{
		1.0, 50.0, 0.1
	});
