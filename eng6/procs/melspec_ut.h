...
using melspec = sel::eng6::proc::melspec<ut_traits>;
...
using mag = sel::eng6::proc::mag<ut_traits>;

class preemphasis_filter : public sel::eng6::Processor1A1B<1,1>
{
...
//	auto filters_size = filters_py.size();
	...
	sel::eng6::proc::rand<ut_traits::input_frame_size> rng1(seed);
