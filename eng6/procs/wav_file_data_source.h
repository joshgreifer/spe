...
#pragma pack(pop)
	...
	class Stereo16BitReader :
		public sel::eng6::proc::scalar_stream_reader<SAMP16, 1024>
	{
	public:
	...
	template<size_t port_width>class Mono16BitReader :
		public sel::eng6::proc::scalar_stream_reader<SAMP16, port_width>
	{
	public:
		Mono16BitReader(sel::eng6::input_stream& stream, int samps_per_second) :
			sel::eng6::proc::scalar_stream_reader<SAMP16, port_width>(stream, rate_t(samps_per_second, 1)) {}
	};
